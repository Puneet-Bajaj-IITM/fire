...
function Results({ overallAverage, industryAverages }) {
  ...
  return (
    <div className="results-container">
      <div className="results-banner">Recommendations for your next phase of growth</div>
      <div className="stage-header"> You are in the {stage} stage.</div>
      <div className='stage-description'>{description}</div>
      <div className="results-divider"></div>
      <div className="results-disclaimer">
        Please be aware that this report was created for your use, using the information provided in your business self-assessment questionnaire. Therefore, Geo Digital Partners Canada does not take any responsibility or liability for how the report is used by your business or any other individual or entity. 
      </div>
    </div>
  );
}
